...
export default async function AdminCartografia() {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div>
        <h1 className="text-2xl font-semibold text-texto">Cartografia urbana</h1>
      ...
      <section className="space-y-2">
        <h2 className="font-semibold text-texto">Camadas no mapa</h2>
        <ListaCamadas />
      </section>

      <div className="rounded-2xl border border-linha bg-superficie-2 p-5 text-sm space-y-2">
        <p className="font-semibold text-texto">Como preparar o arquivo</p>
        <ol className="list-decimal ml-5 space-y-1 text-texto-2">
